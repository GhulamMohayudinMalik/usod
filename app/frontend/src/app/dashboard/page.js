    ...
    <div className="space-y-8">
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <StatsCard size="lg" title="Security Score" value={`${stats.securityScore}%`} change={3} description="Resolved threats percentage" />
          <StatsCard size="lg" title="Active Threats" value={stats.activeThreats} change={-2} description="Escalated threats count" />
